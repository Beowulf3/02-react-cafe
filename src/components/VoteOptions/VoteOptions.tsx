...
export default function VoteOptions({onVote, onReset, canReset, Reset}: VoteOptionsProps) {
    return (
        <div className={css.container}>
            ...
            {canReset && <button className={`${css.button} ${css.reset}`} onClick={onReset} disabled={!Reset}>Reset</button>}  
        </div>
    ) 
} 